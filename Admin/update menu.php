...
$id = $_REQUEST['id'];
$query = "SELECT * FROM menu_tbl WHERE menu_id = $id";
...
if(isset($_REQUEST["submit"])) {
	...
	$price = $_REQUEST["price"];
	 ...
	 //database connection
	 $query = "UPDATE menu_tbl SET menu = '$menu' ,price = '$price' WHERE menu_id=$id";
...
<div class="col-sm-12">
<form action="update menu.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" style="margin-top:10%; margin-left:10%;">

	<label>Title:</label>
	<input style="width:60%; height:30px; margin-left:5.5%; border-radius: 6px" type="text" name="menu" value='<?php echo $product_data['menu']; ?>'/><br /><br />

	<label>Price:</label>
	<input style="width:60%; height:30px; margin-left:4.8%; border-radius: 6px" type="text" name="price" value='<?php echo $product_data['price']; ?>'/><br /><br />

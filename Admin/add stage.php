...
if(isset($_REQUEST["submit"])) {
	...
	{ 
	 ...
	 $query = "INSERT INTO stage_tbl SET image = '$imagepath', price = '$price'";
...
<div class="col-sm-12">
<form action="add stage.php" method="post" enctype="multipart/form-data" style="margin-top:4%; margin-left:2%">

 	<label style="padding:2%; color:#00795f;"><b>Stage:</b></label>
	<input style=" font-size:9.5px" type="file" name="myimage" /><br />
  
 	<label>Price:</label>
	<input style="width:150px; height:30px; margin-left:4.8%; border-radius: 6px" type="text" name="price" required="required"/><br /><br />
